...
<head>
  ...
  <!-- 
    - primary meta tag
  -->
  <title>Courseware - The Best Program to Enroll for Exchange</title>
  <meta name="title" content="CourseWare - The Best Program to Enroll for Exchange">
  <meta name="description" content="This is an education html template made by corseWare">
...
<body id="top">
  ...
  <header class="header" data-header>
    <div class="container">
      ...
      <a href="#" class="logo">
        <img src="./assets/images/logo.svg" width="162" height="50" alt="CourseWare logo">
      </a>
    ...
    <article>
        ...
        <div class="container">
          ...
          <div class="hero-content">
            ...
            <h1 class="h1 section-title">
              The Best Program to <span class="span">Enroll</span> for Learning
            </h1>

            <p class="hero-text">
              Grab actionable carrer insights with choosing programs designed to turn your passion in to a proffesion.
            </p>
      ...
      <section class="section category" aria-label="category">
        <div class="container">
          ...
          <p class="section-subtitle">Explore Our Categories</p>

          <h2 class="h2 section-title">
            Discover <span class="span">your</span> passion.
          </h2>
              ...
              <div class="category-card" style="--color: 170, 75%, 41%">
                ...
                <div class="card-icon">
                  <img src="./assets/images/category-1.svg" width="40" height="40" loading="lazy"
                    alt="Data Science Analytics" class="img">
                </div>

                <h3 class="h3">
                  <a href="#" class="card-title">Data Science and Analytics</a>
                </h3>

                <p class="card-text">
                  Shape your carrer in the world of Data science.Data Analytics,and Artificial Intelligence with our carefully curated courses. 
                </p>
              ...
              <div class="category-card" style="--color: 351, 83%, 61%">
                ...
                <div class="card-icon">
                  <img src="./assets/images/category-2.svg" width="40" height="40" loading="lazy"
                    alt="Software Development" class="img">
                </div>

                <h3 class="h3">
                  <a href="#" class="card-title">Software Development</a>
                </h3>

                <p class="card-text">
                  Embark on the upskilling journey of Designing & creating cutting edge application.
                </p>
              ...
              <div class="category-card" style="--color: 229, 75%, 58%">
                ...
                <div class="card-icon">
                  <img src="./assets/images/category-3.svg" width="40" height="40" loading="lazy"
                    alt="Programming Courses" class="img">
                </div>

                <h3 class="h3">
                  <a href="#" class="card-title">Programming Courses</a>
                </h3>

                <p class="card-text">
                  Master the intricacies of Programming,fortified with essential DSA principal to tackel realworld challenge with confidence.
                </p>
              ...
              <div class="category-card" style="--color: 42, 94%, 55%">
                ...
                <div class="card-icon">
                  <img src="./assets/images/category-4.svg" width="40" height="40" loading="lazy"
                    alt="Gen AI" class="img">
                </div>

                <h3 class="h3">
                  <a href="#" class="card-title">Gen AI</a>
                </h3>

                <p class="card-text">
                  Gain a Strong foundation in AI fundamentals while exploring real-world application in marketing,design,content creation.
                </p>
      ...
      <section class="section about" id="about" aria-label="about">
        <div class="container">
          ...
          <div class="about-content">
            ...
            <h2 class="h2 section-title">
              Our<span class="span">Mission</span> 
            </h2>

            <p class="section-text">
              We aim to do this by providing exeptional up skilling courses at free of Cost,while Being tech forward to anyone anywhere can access and improve their ability to be successful in life.
            </p>
      ...
      <section class="section blog has-bg-image" id="blog" aria-label="blog"
        ...
        <div class="container">
          ...
          <h2 class="h2 section-title">Get News With CourseWare</h2>
                ...
                <div class="card-content">
                  ...
                  <ul class="card-meta-list">
                    ...
                    <li class="card-meta-item">
                      ...
                      <span class="span">Oct 10, 2024</span>
                    </li>
      ...
      <div class="container grid-list">
        ...
        <div class="footer-brand">
          ...
          <div class="wrapper">
            ...
            <address class="address">St Norwich NR2</address>
          </div>
          ...
          <div class="wrapper">
            ...
            <a href="mailto:info@CourseWare.com" class="footer-link">info@eduweb.com</a>
          </div>
